...
- Aim for **at most three discovery questions total**, including the source question. Ask one main question per message. Do not hide several questions inside one paragraph or present all questions at once.
...
Build the overview around visuals, not explanatory paragraphs or a wall of metric cards. Use a large primary chart and a small, purposeful mix of supporting visual forms. Keep headline measures compact, titles descriptive, units visible, and instructions to one line. Move detailed interpretation, calculations, caveats, and record tables into drilldowns, expandable notes, and About. Keep sample labels and consequential missing/stale warnings immediately visible.
